                                ...
                                {            
                                    ...
                                    ["fields"]= {
                                        ...
                                        },
                                        {
                                            ...
                                            ["value"]= "```Người dùng đã chạy script vitor hub Auto Farm Cảm Ơn Vì Đã Dùng RinX!!!!```",
                                            ["inline"]= true
                                            },
                                       {
                                     ["name"] = "𝙅𝙤𝙗 𝙄𝙙",
...
local Tabs = {
    Main = Window:AddTab({ Title = "Main", Icon = "rbxassetid://93836511749172" }),
    Setting = Window:AddTab({ Title = "Setting", Icon = "rbxassetid://93836511749172" }),
    Stats = Window:AddTab({ Title = "Stats", Icon = "rbxassetid://93836511749172" }),
    Player = Window:AddTab({ Title = "Player", Icon = "rbxassetid://93836511749172" }),
    Teleport = Window:AddTab({ Title = "Teleport", Icon = "rbxassetid://93836511749172" }),
    Fruit = Window:AddTab({ Title = "Fruit", Icon = "rbxassetid://93836511749172" }),
    Raid = Window:AddTab({ Title = "Raid", Icon = "rbxassetid://93836511749172" }),
    Race = Window:AddTab({ Title = "Race V4", Icon = "rbxassetid://93836511749172" }),
    Shop = Window:AddTab({ Title = "Shop", Icon = "rbxassetid://93836511749172" }),
	Misc = Window:AddTab({ Title = "Misc", Icon = "rbxassetid://93836511749172" }),
}
...
OrionLib:MakeNotification(
        {
            ...
            Image = "rbxassetid://93836511749172",
            Time = 7
        }
    )
_G.lakala = true

setclipboard("vitor hub Is The Best")
	...
	if (getgenv().ED_AntiKick.CheckCaller and not checkcaller() or true) and stringlower(getnamecallmethod()) == "kick" and ED_AntiKick.Enabled then
		if getgenv().ED_AntiKick.SendNotifications then
			StarterGui:SetCore("SendNotification", {
				...
				Icon = "rbxassetid://93836511749172",
				Duration = 2,
			})
		end
...
ImageButton.Image = "http://www.roblox.com/asset/?id=93836511749172"
...
Tabs.Main:AddButton({
        Title = "vitor hub Discord Server",
...
Fluent:Notify({
    Title = "vitor hub",
    Content = "Thanks For Using vitor hub",
    Duration = 8
})
